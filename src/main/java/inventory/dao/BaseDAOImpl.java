...
public class BaseDAOImpl<E> implements BaseDAO<E>{
	...
	public List<E> findAll() {
		...
		queryString.append(" from ").append(getGenericName()).append(" as model where model.activeLag=1");
	...
	public List<E> findByProperty(String property, Object value) {
		...
		StringBuilder queryString = new StringBuilder();
		queryString.append(" from ").append(getGenericName()).append(" as model where model.activeLag=1 and model.").append(property).append("=?");
